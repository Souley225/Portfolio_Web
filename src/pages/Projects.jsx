        ...
        <section className="projects section">
            <div className="container">
                ...
                <p className="section-subtitle">
                    Projets structurés avec une approche MLOps moderne, du feature engineering au déploiement
                </p>
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className="project-header">
                                ...
                                <span className={`tag tag-${project.status}`}>{project.statusLabel}</span>
                            </div>
